...
describe('Applications Browse panel - `Selection Toggler` spec', function () {
    ...
    it(`WHEN applications grid is loaded(no selections) THEN 'selection toggler' should not be displayed`, async () => {
    ...
    it(`WHEN existing application is checked THEN 'selection toggler' gets visible`, async () => {
        let appBrowsePanel = new AppBrowsePanel();
    ...
    it("WHEN two application are checked THEN '2' should appear in 'selection toggler'", async () => {
        let appBrowsePanel = new AppBrowsePanel();
    ...
    it(`GIVEN 'show selection' is clicked WHEN 'hide selection' has been clicked THEN original grid should be restored`, async () => {
        let appBrowsePanel = new AppBrowsePanel();
