...
import type { Readable, RoutedHost } from '../../main/resources/assets/js/shared/sections';
...
export function fakeHost(overrides: Partial<RoutedHost> = {}): RoutedHost {
  return {
    baseUrl: '/admin/tool/_/admin:extension/com.enonic.xp.app.applications:applications',
    extension: 'com.enonic.xp.app.applications:applications',
    locale: 'en',
